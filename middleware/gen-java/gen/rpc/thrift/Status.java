...
public class Status implements org.apache.thrift.TBase<Status, Status._Fields>, java.io.Serializable, Cloneable, Comparable<Status> {
   ...
   * @see ResultCode
   */
  public @org.apache.thrift.annotation.Nullable ResultCode result; // required
   ...
   * @see ResultCode
   */
  public Status setResult(@org.apache.thrift.annotation.Nullable ResultCode result) {
    this.result = result;
    return this;
  }
        ...
        switch (schemeField.id) {
          case 1: // RESULT
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.result = gen.rpc.thrift.ResultCode.findByValue(iprot.readI32());
